...
import { createSignalEngine } from '../../signals/engine.js';
import { unwrittenRoadSignalModel } from './signals.server.js';
...
export const unwrittenRoadServerModel: JourneyServerModel = {
  ...
  signalEngine: createSignalEngine(journeyV1, unwrittenRoadSignalModel),
  contentHash: hash,
